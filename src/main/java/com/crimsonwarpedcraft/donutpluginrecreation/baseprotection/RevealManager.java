package com.crimsonwarpedcraft.donutpluginrecreation.baseprotection;
...
public class RevealManager {
  ...
  public RevealManager(DonutPluginRecreation plugin) {
    this.plugin = plugin;
    ...
    this.bypassPerm = cfg.getString(
        "hider.bypass-permission", "donutpluginrecreation.hider.bypass");
  ...
  public DonutPluginRecreation plugin() {
    return plugin;
  }
